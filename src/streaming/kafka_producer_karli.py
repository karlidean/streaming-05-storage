"""src/streaming/kafke_producer_karli.py. My kafka producer.
...
from streaming.data_validation.data_contract_karli import (
...
REJECTED_SALES_CSV: Final[Path] = OUTPUT_DIR / "producer_rejected_sales_karli.csv"
